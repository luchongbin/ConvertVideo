...
import com.luchongbin.convertvideolibrary.muxer.ConvertInputSurfaceTexture;
 ...
 */
public class ConvertVideoEncoder {
    ...
    private ConvertInputSurfaceTexture mInputSurface;
     ...
     *
     * */
    public boolean convertVideo(final String sourcePath, String destinationPath, int nwidth, int nheight, int nbitrate, ConvertVideoProgressListener listener) {
...
//            }
    ...
    private void prepareEncoder(MediaFormat inputFormat) {
        ...
        mInputSurface = new ConvertInputSurfaceTexture(mEncoder.createInputSurface());
